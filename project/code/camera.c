...
{
    if(search_stop_line>=85)
    {
        if(boundary_start_left>=80&&boundary_start_right>=80&&left_lost_count<70&&right_lost_count<70&&left_right_lost_count<70)
        {
            if(fabsf(line_err)<=12)
            {
                return 1;//直道
            }
            else
